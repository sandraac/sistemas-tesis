        ...
        <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    <div class="form-group">
                        <button type="button" id="agregar" class="btn btn-info float-right">Agregar producto</button>
                    </div>
                </div>
            </div>
            <div class="form-row">
        ...
        <table id="" class="table table-striped">
            <tfoot>
                <tr>
                    ...
                    <th>
                        <p align="center"><span id="total">PEN 0.00</span> </p>
                    </th>
                </tr>
                <tr>
                    <th colspan="">
                        <p align="center">TOTAL IMPUESTO (18%):</p>
                    </th>
                    <th>
                        <p align="center"><span id="total_impuesto">PEN 0.00</span></p>
                    </th>
                </tr>
                <tr>
                    <th colspan="">
                        <p align="center">TOTAL PAGAR:</p>
                    </th>
                    <th>
                        <p align="center"><span align="center" id="total_pagar_html">PEN 0.00</span> <input type="hidden"
